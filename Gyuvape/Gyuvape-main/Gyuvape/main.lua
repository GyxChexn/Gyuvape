...
do
	...
	if _hookDetected then
		game:GetService('Players').LocalPlayer:Kick('[GyuVapeV4] integrity check failed - what u trying to do???')
		error('[GyuVapeV4] loadstring hook detected - if this is false dm aero', 2)
	end
end
